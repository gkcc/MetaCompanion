...
echo.
echo [Meta Companion] Install plugin to HDT...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".\tools\Install-MetaCompanion.ps1" -BuildPath ".\MetaCompanion\bin\x86\Release\MetaCompanion.dll"
set "ERR=%ERRORLEVEL%"
